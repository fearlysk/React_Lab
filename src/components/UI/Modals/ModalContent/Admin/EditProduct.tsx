...
interface Props {
  ...
  setEditProductModalOpen: React.Dispatch<React.SetStateAction<boolean>>;
  id: number;
}

function EditProduct({ EditProductModalOpen, setEditProductModalOpen, id }: Props) {
    ...
    <div>
      <div className={styles.modalContentFormWrapper}>
        <div className={styles.modalHeader}>
          <div>
            <h1 className={styles.headline}>Edit product</h1>
          </div>
          <div>
            <button type="button" className={styles.closeBtn} onClick={() => setEditProductModalOpen(false)}>
              X
            </button>
          </div>
        </div>
